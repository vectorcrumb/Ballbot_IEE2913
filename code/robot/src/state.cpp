...
void get_opPoint(MATRIX* M_odometry_omniangles, MATRIX* M_odometry_IMUangles, MATRIX* M_torques, STATE_DATA* K, STATE_DATA* x0, TORQUES* u0, int opPoint_number){
    ...
    M_odometry_omniangles->m11=-0.942809;
    M_odometry_omniangles->m12=0.471405;
    M_odometry_omniangles->m13=0.471405;
    M_odometry_omniangles->m21=0;
    M_odometry_omniangles->m22=-0.816497;
    M_odometry_omniangles->m23=0.816497;
    M_odometry_omniangles->m31=0.471405;
    M_odometry_omniangles->m32=0.471405;
    M_odometry_omniangles->m33=0.471405;
